...
func (s *SmartContract) createUser(ctx contractapi.TransactionContextInterface, fname string, email string, idCard string, phone string,city string,address string, pass string) error {
	user := User{
	Fname:   fname,
	Email:  email,
	IdCard: idCard,
	...
	return ctx.GetStub().PutState(idCard, userAsBytes)
	}
