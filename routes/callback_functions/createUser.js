...
async function main(fname,email,idCard,phone,city,address,pass) {
    try {
        ...
        console.log(fname,email,idCard,phone,city,address,pass)

        // Submit the specified transaction.
        await contract.submitTransaction('createCar', 'CAR12', 'Honda', 'Accord', 'Black', 'Tom');

        await contract.submitTransaction('createComplaint',idCard,fname , email ,idCard,phone,city,address, pass);
