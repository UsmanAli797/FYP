...
async function main(namee,dateTime,sectionoflaws,) {
    try {
...
//  console.log(namee,dateTime,sectionoflaws,investigatingoffcers,accusedperson,briefreport,chargedPerson,plea,sentence,judgement)
        ...
        await contract.submitTransaction('CreateJudgement',dateTime,namee,dateTime,sectionoflaws);
        console.log('Judgement report has been submitted');
