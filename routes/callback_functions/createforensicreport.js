...
async function main(evidenceid,report,brief) {
    try {
...
//  console.log(namee,dateTime,sectionoflaws,investigatingoffcers,accusedperson,briefreport,chargedPerson,plea,sentence,judgement)
        ...
        await contract.submitTransaction('CreateEvidenceReport',evidenceid,evidenceid,report,brief);
        console.log('Forensic Report has been submitted');
